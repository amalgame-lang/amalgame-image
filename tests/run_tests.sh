...
echo ""
echo "── Image v0.2 ──────────────────────────────"
run_test "Create 16x8"           "[PASS] Create 16x8"
run_test "Create fill packed"    "[PASS] Create fills with packed colour"
run_test "Fill replaces all"     "[PASS] Fill replaces all pixels"
run_test "SetRGBA + GetRGBA"     "[PASS] SetRGBA + Get[RGBA]"
run_test "Resize 8x4"            "[PASS] Resize to 8x4"
run_test "FlipH"                 "[PASS] FlipH moves (3,4) -> (12,4)"
run_test "FlipV"                 "[PASS] FlipV moves (12,4) -> (12,3)"
run_test "Rotate180"             "[PASS] Rotate180 maps (0,0) -> (3,1)"
run_test "Crop sub-rect"         "[PASS] Crop sub-rect preserves pixels"
run_test "Crop empty window"     "[PASS] Crop rejects empty window"
